...
class bring_back_Slideshow extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'content_alignment',
            [
                'label' => __( 'Content Alignment', 'boka' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'justify-content-center',
                'options' => [
                    'justify-content-start'  => __( 'Start', 'boka' ),
                    'justify-content-center' => __( 'Middle', 'boka' ),
                    'justify-content-end' => __( 'End', 'boka' )
                ],
            ]
        );
        ...
        $repeater->add_control(
            'sliderImage',
            [
                'label' => __( 'Choose Slider Image', 'boka' ),
                'type' => \Elementor\Controls_Manager::MEDIA,
                'description' => __( 'Recommended size of image: 1920x1000 ', 'boka' ),
                'default' => [
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'Grow your business.', 'boka' ),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'Having a proper appearance devices tablets more and smartphone can eportant.', 'boka' )
            ]
        );
        $repeater->add_control(
            'content_animation',
        ...
        $repeater->add_control(
            'button_label',
            [
                'label' => __( 'Button Label', 'boka' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __( 'Get Started', 'boka' )
            ]
        );
        $repeater->add_control(
            'button_url',
            [
                ...
                'placeholder' => __( 'https://www.themetim.com', 'boka' ),
                'show_external' => true,
                'default' => [
                    'url' => '',
                    'is_external' => true,
        ...
        $this->add_control(
            'autoplay',
            [
                'label' => __( 'Autoplay', 'boka' ),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __( 'Show', 'boka' ),
                'label_off' => __( 'Hide', 'boka' ),
                'return_value' => 'true',
                'default' => 'true',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Fade', 'boka' ),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __( 'True', 'boka' ),
                'label_off' => __( 'False', 'boka' ),
                'return_value' => 'true',
                'default' => 'true',
            ]
        );
