...
class bring_back_Text_With_Image extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Text With Image', 'boka' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'We are global business solutions provider.', 'boka' )
            ]
        );
        $this->add_control(
            'paragraph',
            [
                ...
                'default' => __( 'Having a proper appearance devices tablets more and smartphone can eportant when trying getteing customers keep your visitors attention.', 'boka' )
            ]
        );
        $this->add_control(
            'btn_txt',
