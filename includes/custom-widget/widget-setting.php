...
if ( class_exists( 'SiteOrigin_Widget' ) ) {
   ...
   // require get_template_directory() . '/inc/widget/testimonial/testimonial.php';
    ...
    require BOKA_PLUG_DIR . 'includes/custom-widget/recent-blog/recent-blog.php';
    require BOKA_PLUG_DIR . 'includes/custom-widget/testimonial/testimonial.php';
    require BOKA_PLUG_DIR . 'includes/custom-widget/camera-slider/camera-slider.php';
    require BOKA_PLUG_DIR . 'includes/custom-widget/pricing/pricing.php';
    require BOKA_PLUG_DIR . 'includes/custom-widget/heading/heading.php';
    require BOKA_PLUG_DIR . 'includes/custom-widget/content-box/content-box.php';
    require BOKA_PLUG_DIR . 'includes/custom-widget/featured-list/featured-list.php';
    require BOKA_PLUG_DIR . 'includes/custom-widget/list-items/list-items.php';
    require BOKA_PLUG_DIR . 'includes/custom-widget/button/button.php';
    require BOKA_PLUG_DIR . 'includes/custom-widget/team/team.php';
}